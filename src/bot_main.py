...
def check_junta(message : telebot.Message) -> None:
    with open("whitelist.txt", 'r') as file_junta:
        return message.from_user.username in file_junta.readlines()

@bot.message_handler(commands=['hi'])
def say_hello(message):
    if check_junta(message):
